...
{
    public class ServiceTestAPI : AbstractService
    {
        private AbstractDataAPI data;
        public ServiceTestAPI(AbstractDataAPI d)
        {
            data = d;
        }
        ...
        public override List<IBook> getAllBooks()
        {
            ...
            {
                result.Add(new TestBook(book.bookID, book.title, book.description, book.author_last_name, book.author_first_name, book.lent));
            }
        ...
        public override List<IReader> getAllReader()
        {
            ...
            {
                result.Add(new TestReader(r1.readerID, r1.first_name, r1.last_name));
            }
        ...
        public override List<ILendList> getAllLendList()
        {
            ...
            {
                result.Add(new TestLendList(l1.lend_listID, l1.bookID, l1.readerID));
            }
