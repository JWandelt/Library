using DataLayer;
using PresentationLayerTests.TestModelData;
using Service;
using Service.IData;
using System;
...
namespace PresentationLayerTests.Generators
{
    public class ModelGenerator : IDataGenerator
    {
        ...
        TestBookModel testBookModel;
        TestReaderModel testReaderModel;
        TestLendListModel testLendListModel;
        ...
        {
            data = new DataLayerAPI();
            abstractService = new PresentationTestService(data);
            testBookModel = new TestBookModel(abstractService);
            testReaderModel = new TestReaderModel(abstractService);
            testLendListModel = new TestLendListModel(abstractService);
        }

        public TestBookModel TestBookModel { get { return testBookModel; } }
        public TestReaderModel TestReaderModel { get { return testReaderModel; } }
        public TestLendListModel TestLendListModel { get { return testLendListModel; } }
