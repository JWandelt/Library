...
{
    internal class TInvoiceIn : IEvent
    {
            IUser delieveredBy;
            IUser receivedBy;
            ...
            public TInvoiceIn(IUser sender, IUser receiver, float price, string invoiceNumber, int day, int month, int year, List<IState> orderedProducts)
            {
                Sender = sender;
                Receiver = receiver;
